...
const VerticalNavigation = ({ onSelect, setEnvironment }) => {
            ...
            {showEnvironments && (
                <div className="flex flex-col space-y-2 ml-4">
                    <button className="py-1 px-3 rounded-full bg-gray-600 hover:bg-gray-500 text-white text-xs"
                            onClick={() => setEnvironment('autoshop')}>Autoshop
                    </button>
                    <button className="py-1 px-3 rounded-full bg-gray-600 hover:bg-gray-500 text-white text-xs"
                            onClick={() => setEnvironment('street')}>Urban
                    </button>
                    <button className="py-1 px-3 rounded-full bg-gray-600 hover:bg-gray-500 text-white text-xs"
                            onClick={() => setEnvironment('sunset')}>Sunset
                    </button>
                </div>
            )}
